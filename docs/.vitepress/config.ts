      ...
      "/": [
        {
          ...
          items: [
            ...
            { text: "Custom serialization", link: "/guide/custom-serialization" },
      ...
      "/plugin-pinia/": [
        {
          ...
          items: [
            ...
            { text: "Custom serialization", link: "/plugin-pinia/guide/custom-serialization" },
            { text: "Migration", link: "/plugin-pinia/guide/migration" },
          ],
        },
      ],
      "/plugin-svelte/": [
        {
          ...
          items: [
            ...
            { text: "Custom serialization", link: "/plugin-svelte/guide/custom-serialization" },
            { text: "Migration", link: "/plugin-svelte/guide/migration" },
          ],
        },
      ],
      "/plugin-valtio/": [
        {
          ...
          items: [
            ...
            { text: "Custom serialization", link: "/plugin-valtio/guide/custom-serialization" },
            { text: "Migration", link: "/plugin-valtio/guide/migration" },
          ],
        },
      ],
      "/plugin-vue/": [
        {
          ...
          items: [
            ...
            { text: "Custom serialization", link: "/plugin-vue/guide/custom-serialization" },
            { text: "Migration", link: "/plugin-vue/guide/migration" },
          ],
        },
      ],
      "/plugin-zustand/": [
        {
          ...
          items: [
            ...
            { text: "Custom serialization", link: "/plugin-zustand/guide/custom-serialization" },
            { text: "Migration", link: "/plugin-zustand/guide/migration" },
          ],
        },
      ],
    },
